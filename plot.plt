...
set logscale x
set xtics ("64 bytes" 64, "512 bytes" 512, "4 KiB" 4096, "48 KiB (L1)" 48 * 1024, "256 KiB" 256 * 1024, "1.25 MiB (L2)" 1280 * 1024, "4 MiB" 4 * 1024 * 1024, "8 MiB" 8 * 1024 * 1024, "18 MiB (L3)" 18 * 1024 * 1024, "64 MiB" 64 * 1024 * 1024, "1 GiB" 1024 * 1024 * 1024, "4 GiB" 3.982 * 1024 * 1024 * 1024)
set ytics 1
